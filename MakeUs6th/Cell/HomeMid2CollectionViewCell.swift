//
//  HomeMid2CollectionViewCell.swift
//  MakeUs6th
//
...
class HomeMid2CollectionViewCell: UICollectionViewCell {
    
    static let registerId = "\(HomeMid2CollectionViewCell.self)"
    ...
    let imageView = UIImageView().then {
        $0.image = #imageLiteral(resourceName: "example2")
